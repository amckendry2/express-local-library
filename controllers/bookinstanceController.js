...
exports.bookinstance_delete_post = function(req, res) {
    req.checkBody('bookinstance_id', 'BookInstance id must exist').notEmpty();
...
exports.bookinstance_update_post = function(req, res) {
    ...
    if(errors){
        Book.find({}, 'title')
            .exec(function(err, books){
                if (err){return next(err);}
                res.render('bookinstance_form', {title: 'Update Bookinstance', book_list: books, bookinstance: bookinstance, errors: errors})
            })
    }
    else{
