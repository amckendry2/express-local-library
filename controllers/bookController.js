...
exports.book_create_post = function(req, res) {
    ...
    if(errors){
        async.parallel({
            ...
            res.render('book_form', {title: 'Create Book', authors:results.authors, genre:results.genre, book: book, errors: errors});
        });
    }
    else{
...
exports.book_delete_post = function(req, res) {
    ...
    req.checkBody('bookid', 'Bookid must exist').notEmpty();
